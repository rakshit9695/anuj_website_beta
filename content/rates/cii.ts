/**
 * Cost Inflation Index (base 2001-02 = 100). EDITABLE. Used by the rate chart
 * and the capital-gains calculator. Verify the latest notified value each year.
 */
...
export const ciiYears = Object.keys(cii);
