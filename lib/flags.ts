...
export const flags = {
  SHOW_CLIENT_LOGOS: bool(process.env.NEXT_PUBLIC_SHOW_CLIENT_LOGOS, true),
  SHOW_TESTIMONIALS: bool(process.env.NEXT_PUBLIC_SHOW_TESTIMONIALS, true),
  SHOW_TRANSACTIONS: bool(process.env.NEXT_PUBLIC_SHOW_TRANSACTIONS, true),
  SHOW_AWARDS: bool(process.env.NEXT_PUBLIC_SHOW_AWARDS, true),
